      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            >
              لديك أسئلة حول منتجاتنا أو تحتاج مساعدة في طلب؟ نحن هنا لمساعدتك!
            </motion.p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 dark:text-dark-text">البريد الإلكتروني</h3>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 dark:text-dark-text">الهاتف</h3>
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 dark:text-dark-text">العنوان</h3>
              ...
              <motion.div 
                ...
                transition={{ delay: 2.0 }}
              >
                <h3 className="text-lg font-semibold text-gray-900 dark:text-dark-text mb-4">ساعات العمل</h3>
