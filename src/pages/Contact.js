            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-brand-red text-white py-3 rounded-md font-semibold hover:bg-red-700 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">hello@stickwithmo.com</p>
                      <p className="text-gray-600">support@stickwithmo.com</p>
                    </div>
                  </div>
