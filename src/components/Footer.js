      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              {/* <a 
                ...
                className="text-gray-300 hover:text-blue-500 transition-colors duration-200 p-2 rounded-full hover:bg-gray-700 dark:hover:bg-gray-600"
              ...
              {/* <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-blue-400 transition-colors duration-200 p-2 rounded-full hover:bg-gray-700 dark:hover:bg-gray-600"
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-pink-500 transition-colors duration-200 p-2 rounded-full hover:bg-gray-700 dark:hover:bg-gray-600"
              ...
              {/* <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-red-500 transition-colors duration-200 p-2 rounded-full hover:bg-gray-700 dark:hover:bg-gray-600"
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-black dark:hover:text-white transition-colors duration-200 p-2 rounded-full hover:bg-gray-700 dark:hover:bg-gray-600"
        ...
        <div className="border-t border-gray-700 dark:border-dark-border mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © 2024 Stick With Mo. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
